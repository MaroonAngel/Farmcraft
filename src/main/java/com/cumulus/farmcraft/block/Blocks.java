...
import com.cumulus.farmcraft.block.trellis.VineTrellis;
...
public class Blocks {
    ...
    public static final VineTrellis GRAPE_TRELLIS = new VineTrellis(FabricBlockSettings.of(Material.WOOD).sounds(BlockSoundGroup.SWEET_BERRY_BUSH).nonOpaque().hardness(0.1f));
